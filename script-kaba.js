function showContent(type) {
    ...
    if (type === "include") {
      ...
      contentBox.innerHTML = `
        ...
        <ul>
          <li><strong>Pagaralam:</strong> Rp400.000</li>
          <li><strong>Basecamp:</strong> Rp400.000</li>
          <li><strong>Palembang:</strong> Rp850.000</li>
        </ul>
        <p><a href="https://maps.app.goo.gl/qfKxVGR6vZrZ1XbG7" target="_blank">📌 Lihat lokasi Gunung Kaba di Google Maps</a></p>
      `;
    }
  }
  
  // Countdown ke tanggal trip Gunung Kaba
  ...
  document.getElementById("formPendaftaran").addEventListener("submit", function (e) {
    ...
    const pesan = `Halo kak! Saya ingin daftar trip Gunung Kaba:%0A
  Nama: ${nama}%0A
  No HP: ${hp}%0A
